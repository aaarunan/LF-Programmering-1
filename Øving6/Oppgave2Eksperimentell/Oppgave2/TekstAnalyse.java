...
public class TekstAnalyse {
    ...
    private String alfabetetString = "ABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ";

    private void init() {

            ArrayList<Alfabetet> alfabetet = new Alfabetet()
            for (int i = 0; i < alfabetetString.length(); i++) {
                alfabetet.set(i, Alfabetet(alfabetetString));
            }
    }
